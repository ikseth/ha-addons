...
- **IP en la VLAN 45: `192.0.2.184`** (confirmada el 2026-08-03; es DHCP, puede
...
1. Subir el binario: `smbclient //192.0.2.184/C$ -U "EXAMPLE/<usuario>%<clave>" -c 'put ha4win.exe Windows\Temp\ha4win.exe'`.
